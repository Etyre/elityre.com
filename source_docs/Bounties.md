...
If you know about something, or can teach me something, that solves an open problem of mine, I'll compensate you for the knowledge.
...
### $50,000 maximum - Any intervention that measurably improves my personal learning rate
...
Specifically, I'm interested in methods for rapidly shifting into the following physiological/ psychological states:

- "Amped up" for physical exercise (high energy, low energy-barrier to intense physical exertion)
- Highly focused, for doing intellectual work
- A state of heightened social acuity for coaching and conversational facilitation

I've experimented with a number of methods in this space including meditation, specific music, isochronic tones, auto-suggestion, and chemical stimulants. I'm interested in anything that might be faster or more reliable than my current toolset. That might include conditioned triggers, biofeedback, brain entrainment, hypnotic processes, or something even weirder. I'll pay out a bounty for anything that I end up using regularly.

### $1,000 - Increase my typing speed by at least 10 wpm

[Over the course of 2020](https://efficacyengineering.wordpress.com/category/project-learning-to-touch-type-fluidly/), I brought my average typing speed (as measured in [typeracer](https://play.typeracer.com/)) up from about 59 words per minute to an average speed of about 75 wpm. I haven't put much effort into it since then, but I’m interested in any intervention that would systematically increase my typing speed into the range of 80 to 90 wpm, with 15 or fewer hours of practice.

### $500 - Any intervention that would allow me to read precisely and correctly

I have some kind of dyslexia-like cognitive bug such that I have substantial difficulty reading individual characters correctly. Unless I am going very slowly and carefully, paying attention with high intensity, and sometimes even then, I’m apt to read words and especially numbers incorrectly. For instance, I’ll read the number “53” as “38”, or “24” as “28” and not notice that I made an error.
...
- increase my sleep efficiency (ie the time that I'm actually asleep while in bed)
...
- Permanently cure my food allergy to nuts
...
### $50 - A photo of me that displaces one of my top 4 photos, ranked by total score, on [photofeeler.com](https://www.photofeeler.com).
