...
I use a MacBook pro as my main computer.

I use Brave as my main browser, and Chrome as a secondary browser for my always-open tracking documents.

I’ve set up profiles in Brave: Personal and Palisade.

### My browser extensions 

(Or checklist for setting up a new browser)

#### Pinned in the toolbar

- [1password](https://chromewebstore.google.com/detail/1password-–-password-mana/aeblfdkhhhdcdjpifhhbdiojplfjncoa)
...
- [Smart sessions - tab manager](https://chromewebstore.google.com/detail/smart-sessions-tab-manage/hhfefdiablijkjnbkmdfbopiimjilchh)
...
- [Inbox when ready for gmail](https://chromewebstore.google.com/detail/inbox-when-ready-for-gmai/cdedhgmbfjhobfnphaoihdfmnjidcpim)
- [Block site](https://chromewebstore.google.com/detail/block-site/nkedbnokglppcmiencngilkkhhnpcfjb)
  - Blocking:
    - Twitter
    - Youtube
    - XKCD
    - smbc-comics
    - existential comics
- [HTML content blocker](https://chromewebstore.google.com/detail/html-content-blocker/nobnkgabkebhhlgfddbemmefjnjnahoe)
  - Blocking: All media elements
    - Whitelist:
      - Khan Academy
      - 3blue1brown.com
      - Coursera.org
...
- [Video speed controller](https://chromewebstore.google.com/detail/video-speed-controller/nffaoalbilbmmfgbnbgppjihopabppdk)
  - Remapping hotkeys (noting that I use Colemak):
    - Decrease speed: S
    - Increase speed: T
    - Rewind: W
    - Advance: F
