...
- Barbell squats
  - These are most important. For some reason doing squats [seems to have](https://efficacyengineering.wordpress.com/2020/11/08/squats-made-a-big-difference/) a huge impact on my wellbeing that no other exercise does.
- Barbell bench press
...
* I set the treadmill speed to 10.6 mph during the high intensity intervals.
* I include a 30 second "ramp up" interval immediately before each high intensity interval, to allow the treadmill to get up to speed, and to allow my heart rate to get up to 170 bps.
...
- I sometimes spend hours walking around a neighborhood. My rule is that that I’ll count this as my exercise for the day only if I walked enough that my feet are sore, which is typically around 20,000 steps, according to my Oura ring.
